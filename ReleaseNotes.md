...
<ul>
<li><a href="#sec-1">1. Version 0.6.3 - 2014-06-23</a>
<ul>
<li><a href="#sec-1-1">1.1. Requirements</a></li>
<li><a href="#sec-1-2">1.2. Major changes</a>
<ul>
<li><a href="#sec-1-2-1">1.2.1. Version changing supports forks of OpenFOAM</a></li>
</ul>
</li>
<li><a href="#sec-1-3">1.3. Incompatibilities</a>
<ul>
<li><a href="#sec-1-3-1">1.3.1. Change of command interface of <code>pyFoamSTLUtility.py</code></a></li>
<li><a href="#sec-1-3-2">1.3.2. If <code>0.org</code> is present <code>pyFoamCloneCase.py</code> and <code>pyFoamPackCase.py</code> ignore <code>0</code></a></li>
</ul>
</li>
<li><a href="#sec-1-4">1.4. Bugfixes</a>
<ul>
<li><a href="#sec-1-4-1">1.4.1. PlotWatcher has long times between updates if pickling takes long</a></li>
<li><a href="#sec-1-4-2">1.4.2. <code>pyFoamPVSnapshot.py</code> fails for newer paraview-versions</a></li>
<li><a href="#sec-1-4-3">1.4.3. SamplePlot failed when valueNames are unspecified</a></li>
<li><a href="#sec-1-4-4">1.4.4. <code>pyFoamTimelinePlot.py</code> failed Numpy/Pandas output of vector fields</a></li>
<li><a href="#sec-1-4-5">1.4.5. <code>alternateAxis</code> ignored for slave</a></li>
<li><a href="#sec-1-4-6">1.4.6. <code>pyFoamCaseReport.py</code> more stable for binary <code>boundary</code>-files</a></li>
<li><a href="#sec-1-4-7">1.4.7. <code>SpreadsheetData</code> returns data which breaks certain Pandas-operations</a></li>
<li><a href="#sec-1-4-8">1.4.8. <code>pyFoamCloneCase.py</code> added duplicates to the archive</a></li>
<li><a href="#sec-1-4-9">1.4.9. <code>nonuniform</code> of length 3 not correctly printed</a></li>
</ul>
</li>
<li><a href="#sec-1-5">1.5. New features/Utilities</a>
<ul>
<li><a href="#sec-1-5-1">1.5.1. <code>pyFoamPrepareCase.py</code> for case preparation</a></li>
<li><a href="#sec-1-5-2">1.5.2. <code>pyFoamIPythonNotebook.py</code> for generating and manipulating IPython-notebooks</a></li>
<li><a href="#sec-1-5-3">1.5.3. Additional sub-module <code>PyFoam.IPython</code></a></li>
<li><a href="#sec-1-5-4">1.5.4. Additional sub-module <code>PyFoam.Wrappers</code></a></li>
</ul>
</li>
<li><a href="#sec-1-6">1.6. Enhancements to Utilities</a>
<ul>
<li><a href="#sec-1-6-1">1.6.1. <code>pyFoamSampleplot</code> has option to use index instead of time in filenames</a></li>
<li><a href="#sec-1-6-2">1.6.2. <code>pyFoamListCases.py</code> Allows addition of custom data</a></li>
<li><a href="#sec-1-6-3">1.6.3. Switch compiler versions</a></li>
<li><a href="#sec-1-6-4">1.6.4. <code>pyFoamVersion.py</code> reports the installed versions better</a></li>
<li><a href="#sec-1-6-5">1.6.5. Offscreen rendering can be switched off in <code>pyFoamPVSnapshot.py</code></a></li>
<li><a href="#sec-1-6-6">1.6.6. Write 3D-data in <code>pyFoamPVSnapshot.py</code></a></li>
<li><a href="#sec-1-6-7">1.6.7. Added capabilities to <code>pyFoamSTLUtility</code></a></li>
<li><a href="#sec-1-6-8">1.6.8. <code>pyFoamDecomposer.py</code> switches off function objects</a></li>
<li><a href="#sec-1-6-9">1.6.9. <code>pyFoamCloneCase.py</code> clones more stuff</a></li>
</ul>
</li>
<li><a href="#sec-1-7">1.7. Enhancements to the Library</a>
<ul>
<li><a href="#sec-1-7-1">1.7.1. <code>BasicRunner</code> now can print the command line that is actually used</a></li>
<li><a href="#sec-1-7-2">1.7.2. <code>ClusterJob</code> now can live without a machinefile</a></li>
<li><a href="#sec-1-7-3">1.7.3. Enhanced treatment of symlinks during cloning</a></li>
<li><a href="#sec-1-7-4">1.7.4. <code>AnalyzedCommon</code> clears the <code>analyzed</code>-directory</a></li>
<li><a href="#sec-1-7-5">1.7.5. <code>TimelineDirectory</code> is more tolerant</a></li>
<li><a href="#sec-1-7-6">1.7.6. Possibility of a subcommand-interface for utilities</a></li>
<li><a href="#sec-1-7-7">1.7.7. <code>STLUtility</code> accepts file-handles</a></li>
<li><a href="#sec-1-7-8">1.7.8. <code>addClone</code> in <code>SolutionDirectory</code> accepts glob patterns</a></li>
<li><a href="#sec-1-7-9">1.7.9. <code>execute</code> in <code>Utilities</code> allows specification of working directory and echoing of output</a></li>
<li><a href="#sec-1-7-10">1.7.10. <code>rmtree</code> and <code>copytree</code> more tolerant</a></li>
<li><a href="#sec-1-7-11">1.7.11. Enhanced support for booleans in the parser</a></li>
<li><a href="#sec-1-7-12">1.7.12. Application classes now allow specifying options as keyword parameters</a></li>
<li><a href="#sec-1-7-13">1.7.13. <code>SolutionDirector</code> now can classify directories in the <code>postProcessing</code>-directory</a></li>
<li><a href="#sec-1-7-14">1.7.14. <code>pyFoamSamplePlot.py</code> now more flexible for distributions</a></li>
<li><a href="#sec-1-7-15">1.7.15. <code>DictProxy</code> now has a <code>dict</code>-like <code>update</code>-method</a></li>
<li><a href="#sec-1-7-16">1.7.16. <code>FoamFileGenerator</code> automatically quotes strings</a></li>
<li><a href="#sec-1-7-17">1.7.17. Children of <code>FileBasis</code> now can be used with the <code>with</code>-statement</a></li>
</ul>
</li>
</ul>
</li>
<li><a href="#sec-2">2. Version 0.6.2 - 2013-11-03</a>
<ul>
<li><a href="#sec-2-1">2.1. Major changes</a>
<ul>
<li><a href="#sec-2-1-1">2.1.1. Use of <code>pandas</code>-library</a></li>
</ul>
</li>
<li><a href="#sec-2-2">2.2. Incompatibilities</a>
<ul>
<li><a href="#sec-2-2-1">2.2.1. Different separator for databases in CSV-files</a></li>
<li><a href="#sec-2-2-2">2.2.2. Change of independent variable name in sample data</a></li>
</ul>
</li>
<li><a href="#sec-2-3">2.3. Bugfixes</a>
<ul>
<li><a href="#sec-2-3-1">2.3.1. <code>pyFoamPackCase.py</code> does not handle symbolic links correctly</a></li>
<li><a href="#sec-2-3-2">2.3.2. <code>pyFoamPotentialRunner.py</code> not working with OpenFOAM 2.0 or newer</a></li>
<li><a href="#sec-2-3-3">2.3.3. <code>pyFoamListCase.py</code> fails with <code>controlDict</code> that use preprocessing</a></li>
<li><a href="#sec-2-3-4">2.3.4. Cloning fails in symlink-mode if files are specified twice</a></li>
</ul>
</li>
<li><a href="#sec-2-4">2.4. Utilities</a>
<ul>
<li><a href="#sec-2-4-1">2.4.1. <code>pyFoamPotentialRunner.py</code> now allows removing of <code>functions</code> and <code>libs</code></a></li>
<li><a href="#sec-2-4-2">2.4.2. The Runner-utilities now have more options for clearing</a></li>
</ul>
</li>
<li><a href="#sec-2-5">2.5. Library</a>
<ul>
<li><a href="#sec-2-5-1">2.5.1. <code>SolutionDirectory</code> and <code>TimeDirectory</code> are more tolerant</a></li>
<li><a href="#sec-2-5-2">2.5.2. <code>ClusterJob</code> now handles template files</a></li>
<li><a href="#sec-2-5-3">2.5.3. Additional parameters in <code>ClusterJob</code></a></li>
<li><a href="#sec-2-5-4">2.5.4. Custom data in directory easier accessible</a></li>
<li><a href="#sec-2-5-5">2.5.5. <code>SolverJob</code> now allows compression of output</a></li>
<li><a href="#sec-2-5-6">2.5.6. <code>PyFoamApplication</code>-class now allows quick access to data</a></li>
</ul>
</li>
<li><a href="#sec-2-6">2.6. New features/Utilities</a>
<ul>
<li><a href="#sec-2-6-1">2.6.1. Post-run hook that sends mail at the end of run</a></li>
<li><a href="#sec-2-6-2">2.6.2. New utility <code>pyFoamCompressCases.py</code></a></li>
<li><a href="#sec-2-6-3">2.6.3. Paraview-module to read additional data</a></li>
</ul>
</li>
<li><a href="#sec-2-7">2.7. Enhancements</a>
<ul>
<li><a href="#sec-2-7-1">2.7.1. <code>pyFoamRedoPlot.py</code> can plot in XKCD-mode</a></li>
<li><a href="#sec-2-7-2">2.7.2. <code>pyFoamListCases.py</code> now displays disk usage in human readable form</a></li>
<li><a href="#sec-2-7-3">2.7.3. <code>pyFoamClearCase.py</code> more flexible in selection of data to be removed</a></li>
<li><a href="#sec-2-7-4">2.7.4. <code>pyFoamFromTemplate.py</code> automatically chooses template and default values</a></li>
<li><a href="#sec-2-7-5">2.7.5. <code>pyFoamDumpRunDatabaseToCSV.py</code> can disable standard-fields</a></li>
<li><a href="#sec-2-7-6">2.7.6. <code>pyFoamDumpRunDatabaseToCSV.py</code> prints <code>pandas</code>-object</a></li>
<li><a href="#sec-2-7-7">2.7.7. Better debugging with <code>ipdb</code></a></li>
<li><a href="#sec-2-7-8">2.7.8. Interactive shell after execution for utilities</a></li>
<li><a href="#sec-2-7-9">2.7.9. Utilities that read quantitative data convert to <code>pandas</code>-data and/or <code>numpy</code></a></li>
<li><a href="#sec-2-7-10">2.7.10. Utilities that read quantitative data write Excel files</a></li>
<li><a href="#sec-2-7-11">2.7.11. Specify additional settings for <code>GnuPlot</code> in <code>customRegexp</code></a></li>
<li><a href="#sec-2-7-12">2.7.12. More flexible data specification for <code>pyFoamSamplePlot.py</code></a></li>
<li><a href="#sec-2-7-13">2.7.13. <code>pyFoamSamplePlot.py</code> now allows specification of x-range</a></li>
</ul>
</li>
</ul>
</li>
<li><a href="#sec-3">3. Version 0.6.1 - 2013-05-24</a>
<ul>
<li><a href="#sec-3-1">3.1. Major changes</a></li>
<li><a href="#sec-3-2">3.2. Bugfixes</a>
<ul>
<li><a href="#sec-3-2-1">3.2.1. Restoring of <code>controlDict</code> after <code>write</code></a></li>
<li><a href="#sec-3-2-2">3.2.2. Custom-plot type <code>slave</code> not working if no <code>master</code> defined</a></li>
<li><a href="#sec-3-2-3">3.2.3. <code>-list-only</code> did not correctly parse lists with a numeric prefix</a></li>
</ul>
</li>
<li><a href="#sec-3-3">3.3. Utilities</a>
<ul>
<li><a href="#sec-3-3-1">3.3.1. <code>pyFoamBuildHelper.py</code> now allow more than one action</a></li>
<li><a href="#sec-3-3-2">3.3.2. Utilities warn if OpenFOAM-version is unset</a></li>
<li><a href="#sec-3-3-3">3.3.3. <code>pyFoamUpgradeDictionariesTo20.py</code> allows single files</a></li>
<li><a href="#sec-3-3-4">3.3.4. <code>pyFoamUpgradeDictionariesTo20.py</code> transforms reaction-schemes</a></li>
<li><a href="#sec-3-3-5">3.3.5. <code>pyFoamUpgradeDictionariesTo20.py</code> transforms thermophysical data</a></li>
<li><a href="#sec-3-3-6">3.3.6. <code>pyFoamCloneCase</code> now allows creating directory that symlinks to the original</a></li>
<li><a href="#sec-3-3-7">3.3.7. <code>pyFoamClearCase.py</code> now removes <code>postProcessing</code> and allows removal of additional files</a></li>
<li><a href="#sec-3-3-8">3.3.8. Improvements to <code>pyFoamVersion.py</code></a></li>
<li><a href="#sec-3-3-9">3.3.9. Additional files automatically cloned</a></li>
<li><a href="#sec-3-3-10">3.3.10. <code>pyFoamDisplayBlockMesh.py</code> uses the same options for template format as <code>pyFoamFromTemplate.py</code></a></li>
</ul>
</li>
<li><a href="#sec-3-4">3.4. Library</a>
<ul>
<li><a href="#sec-3-4-1">3.4.1. Improvements in syntax of <code>ParsedParameterFile</code></a></li>
<li><a href="#sec-3-4-2">3.4.2. <code>Utilities</code>-class now function to find files matching a pattern</a></li>
<li><a href="#sec-3-4-3">3.4.3. VCS ignores more files</a></li>
</ul>
</li>
<li><a href="#sec-3-5">3.5. New features/Utilities</a>
<ul>
<li><a href="#sec-3-5-1">3.5.1. New Utility <code>pyFoamSymlinkToFile.py</code></a></li>
</ul>
</li>
</ul>
</li>
<li><a href="#sec-4">4. Version 0.6.0 - 2013-03-14</a>
<ul>
<li><a href="#sec-4-1">4.1. Major changes</a>
<ul>
<li><a href="#sec-4-1-1">4.1.1. Adaption to work with Python3</a></li>
<li><a href="#sec-4-1-2">4.1.2. New ThirdParty-Libraries</a></li>
<li><a href="#sec-4-1-3">4.1.3. Porting to <code>Windows</code></a></li>
<li><a href="#sec-4-1-4">4.1.4. Experimental port to <code>pypy</code></a></li>
</ul>
</li>
<li><a href="#sec-4-2">4.2. Third-Party</a>
<ul>
<li><a href="#sec-4-2-1">4.2.1. Upgraded <code>ply</code> to 3.4</a></li>
</ul>
</li>
<li><a href="#sec-4-3">4.3. Infrastructure</a>
<ul>
<li><a href="#sec-4-3-1">4.3.1. Parameters can't be modified in <code>CTestRun</code> after initialization</a></li>
<li><a href="#sec-4-3-2">4.3.2. Treat timeouts in the <code>MetaServer</code> right</a></li>
<li><a href="#sec-4-3-3">4.3.3. Add <code>execute</code>-method to <code>ClusterJob</code></a></li>
<li><a href="#sec-4-3-4">4.3.4. Add possibility to run specific modules before or after the solver</a></li>
<li><a href="#sec-4-3-5">4.3.5. Parameters added to the info about the run</a></li>
<li><a href="#sec-4-3-6">4.3.6. Parameter handling in <code>ClusterJob</code> extended</a></li>
<li><a href="#sec-4-3-7">4.3.7. Run data written alongside <code>PickledPlots</code></a></li>
<li><a href="#sec-4-3-8">4.3.8. <code>BasicRunner</code> collects error and warning texts</a></li>
</ul>
</li>
<li><a href="#sec-4-4">4.4. Library</a>
<ul>
<li><a href="#sec-4-4-1">4.4.1. <code>TemplateFile</code> now uses <code>pyratemp</code></a></li>
<li><a href="#sec-4-4-2">4.4.2. Clearer error message in Application-classes</a></li>
<li><a href="#sec-4-4-3">4.4.3. Output is only colored if it goes to the terminal</a></li>
<li><a href="#sec-4-4-4">4.4.4. <code>error</code>-method of application classes now raises an exception</a></li>
<li><a href="#sec-4-4-5">4.4.5. <code>ParsedParameterFile</code> now knows how to handle binary files</a></li>
<li><a href="#sec-4-4-6">4.4.6. <code>LabledReSTTable</code> for more flexible table generation</a></li>
<li><a href="#sec-4-4-7">4.4.7. Plotting classes now allow setting of <code>xlabel</code></a></li>
</ul>
</li>
<li><a href="#sec-4-5">4.5. Utilities</a>
<ul>
<li><a href="#sec-4-5-1">4.5.1. <code>pyFoamFromTemplate.py</code> with new templating engine</a></li>
<li><a href="#sec-4-5-2">4.5.2. <code>pyFoamSamplePlot.py</code> allows using the reference data as basis for comparison</a></li>
<li><a href="#sec-4-5-3">4.5.3. Scaling and offsets are now used in plots of <code>pyFoamSamplePlot.py</code></a></li>
<li><a href="#sec-4-5-4">4.5.4. <code>pyFoamPrintData2DStatistics.py</code> prints relative average error</a></li>
<li><a href="#sec-4-5-5">4.5.5. Enhancements to <code>pyFoamVersion.py</code></a></li>
<li><a href="#sec-4-5-6">4.5.6. <code>pyFoamRunner.py</code> allows hooks</a></li>
<li><a href="#sec-4-5-7">4.5.7. <code>pyFoamRedoPlots.py</code> supports range for plots</a></li>
<li><a href="#sec-4-5-8">4.5.8. <code>pyFoamDisplayBlockMesh.py</code> no supports templates</a></li>
<li><a href="#sec-4-5-9">4.5.9. <code>pyFoamCaseReport.py</code> is tolerant towards binary files</a></li>
<li><a href="#sec-4-5-10">4.5.10. <code>pyFoamSamplePlot.py</code> and <code>pyFoamTimelinePlot.py</code> raise error if no plots are generated</a></li>
<li><a href="#sec-4-5-11">4.5.11. <code>pyFoamSurfacePlot.py</code> can wait for a key</a></li>
<li><a href="#sec-4-5-12">4.5.12. <code>pyFoamEchoDictionary.py</code> is more flexible with binary files</a></li>
<li><a href="#sec-4-5-13">4.5.13. All utilities now have a switch that starts the debugger even with syntax-errors</a></li>
<li><a href="#sec-4-5-14">4.5.14. Utilities now can be killed with <code>USR1</code> and will give a traceback</a></li>
<li><a href="#sec-4-5-15">4.5.15. Switch to switch on <b>all</b> debug options</a></li>
<li><a href="#sec-4-5-16">4.5.16. Plotting utilities now allow specification of x-Axis label</a></li>
<li><a href="#sec-4-5-17">4.5.17. Metrics and compare for <code>pyFoamTimelinePlot.py</code> and <code>pyFoamSamplePlot.py</code> support time ranges</a></li>
<li><a href="#sec-4-5-18">4.5.18. <code>pyFoamDisplayBlockMesh.py</code> allows graphical selection of blocks and patches</a></li>
<li><a href="#sec-4-5-19">4.5.19. <code>pyFoamCloneCase.py</code> and <code>pyFoamPackCase.py</code> accept additional parameters</a></li>
<li><a href="#sec-4-5-20">4.5.20. <code>pyFoamListCases.py</code> now calculates estimated end-times</a></li>
</ul>
</li>
<li><a href="#sec-4-6">4.6. New features</a>
<ul>
<li><a href="#sec-4-6-1">4.6.1. Different "phases" for multi-region solvers</a></li>
<li><a href="#sec-4-6-2">4.6.2. <code>pyFoamChangeBoundaryType.py</code> allows selection of region and time</a></li>
<li><a href="#sec-4-6-3">4.6.3. New class for storing case data in a sqlite-database and associated utilities</a></li>
</ul>
</li>
<li><a href="#sec-4-7">4.7. Bugfixes</a>
<ul>
<li><a href="#sec-4-7-1">4.7.1. Only binary packages of 1.x were found</a></li>
<li><a href="#sec-4-7-2">4.7.2. Option group <i>Regular expressions</i> was listed twice</a></li>
<li><a href="#sec-4-7-3">4.7.3. <code>--clear</code>-option for <code>pyFoamDecompose.py</code> not working</a></li>
<li><a href="#sec-4-7-4">4.7.4. <code>pyFoamDisplayBlockmesh.py</code> not working with variable substitution</a></li>
<li><a href="#sec-4-7-5">4.7.5. Option <code>--function-object-data</code> of <code>pyFoamClearCase.py</code> not working with directories</a></li>
<li><a href="#sec-4-7-6">4.7.6. <code>nonuniform</code> of length 0 not correctly printed</a></li>
<li><a href="#sec-4-7-7">4.7.7. Building of pseudocases with <code>pyFoamRunner.py</code> broken</a></li>
<li><a href="#sec-4-7-8">4.7.8. <code>pyFoamRedoPlot.py</code> did not correctly honor <code>--end</code> and <code>--start</code></a></li>
<li><a href="#sec-4-7-9">4.7.9. <code>WriteParameterFile</code> does not preserve the order of additions</a></li>
<li><a href="#sec-4-7-10">4.7.10. Wrong number of arguments when using <code>TimelinePlot</code> in <code>positions</code>-mode</a></li>
<li><a href="#sec-4-7-11">4.7.11. <code>ClusterJob</code> uses only <code>metis</code> for decomposition</a></li>
<li><a href="#sec-4-7-12">4.7.12. <code>pyFoamSamplePlot.py</code> and <code>pyFoamTimelinePlot.py</code> produced no pictures for regions</a></li>
<li><a href="#sec-4-7-13">4.7.13. Barplots in <code>pyFoamTimelinePlot.py</code> not working if value is a vector</a></li>
<li><a href="#sec-4-7-14">4.7.14. Mysterious deadlocks while plotting long logfiles</a></li>
<li><a href="#sec-4-7-15">4.7.15. Scanning linear expressions form the block coupled solver failed</a></li>
<li><a href="#sec-4-7-16">4.7.16. <code>#include</code> not correctly working with macros in the included file</a></li>
<li><a href="#sec-4-7-17">4.7.17. Macros not correctly expanded to strings</a></li>
<li><a href="#sec-4-7-18">4.7.18. <code>pyFoamPackCase.py</code> in the working directory produces 'invisible' tar</a></li>
<li><a href="#sec-4-7-19">4.7.19. String at the end of a linear solver output makes parsing fail</a></li>
<li><a href="#sec-4-7-20">4.7.20. Paraview utilities not working with higher Paraview versions</a></li>
<li><a href="#sec-4-7-21">4.7.21. Camera settings not honored with <code>pyFoamPVSnapshot.py</code></a></li>
</ul>
</li>
</ul>
</li>
<li><a href="#sec-5">5. Version 0.5.7 - 2012-04-13</a>
<ul>
<li><a href="#sec-5-1">5.1. Parser improvements</a></li>
<li><a href="#sec-5-2">5.2. Utility improvements</a></li>
<li><a href="#sec-5-3">5.3. New Utilities</a></li>
<li><a href="#sec-5-4">5.4. Library improvements</a></li>
<li><a href="#sec-5-5">5.5. Removed utilities</a></li>
<li><a href="#sec-5-6">5.6. Thirdparty</a></li>
<li><a href="#sec-5-7">5.7. Other</a></li>
</ul>
</li>
<li><a href="#sec-6">6. Older Versions</a></li>
</ul>
</div>
</div>
